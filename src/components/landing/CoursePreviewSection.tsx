  ...
  <SectionWrapper id="curso-por-dentro" className="relative overflow-hidden bg-deep-blue py-20 sm:py-28">
    ...
    <div className="relative mx-auto max-w-6xl px-4">
      ...
      <div className="mx-auto mt-12 max-w-4xl space-y-12 sm:space-y-16">
        <motion.article initial={{ opacity: 0, y: 22 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="overflow-hidden rounded-3xl border border-primary/25 bg-card shadow-[0_20px_60px_hsl(192_95%_55%/0.10)]">
        ...
        <motion.article initial={{ opacity: 0, y: 22 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="overflow-hidden rounded-3xl border border-accent/25 bg-card shadow-[0_20px_60px_hsl(142_76%_46%/0.08)]">
          <div className="p-6 text-center sm:p-8">
