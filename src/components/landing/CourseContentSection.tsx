    ...
    <SectionWrapper id="conteudo" className="relative bg-deep-blue py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-6xl px-4">
        <div className="mb-12 text-center">
          ...
          <h2 className="mt-4 font-display text-3xl font-black leading-tight sm:text-5xl">Uma base completa <span className="text-gradient">para a sua evolução.</span></h2>
