  ...
  return (
    <SectionWrapper id="cadastro" className="relative overflow-hidden bg-background py-20 sm:py-28">
      ...
      <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative mx-auto max-w-3xl px-4 text-center">
        ...
        <h2 className="mt-5 font-display text-3xl font-black leading-tight sm:text-5xl">Crie a Sua conta</h2>
        <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">Digite seu nome e o endereço de e-mail que você utilizará para acessar o treinamento mestre da manutenção.</p>
        <form onSubmit={handleSubmit} className="mx-auto mt-9 max-w-xl space-y-4 rounded-3xl border border-border bg-card p-5 text-left shadow-2xl sm:p-7">
          ...
          <button type="submit" className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-6 py-4 text-sm font-black text-primary-foreground shadow-[0_12px_35px_hsl(192_95%_55%/0.2)] transition hover:brightness-110">CONTINUAR A INSCRIÇÃO <ArrowRight className="h-4 w-4" /></button>
