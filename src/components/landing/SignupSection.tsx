...
const SignupSection = () => (
  <SectionWrapper id="cadastro" className="relative overflow-hidden bg-background py-20 sm:py-28">
    ...
    <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative mx-auto max-w-3xl px-4 text-center">
      ...
      <form action="https://pay.kiwify.com.br/eOrXUxm" className="mx-auto mt-9 max-w-xl space-y-4 rounded-3xl border border-border bg-card p-5 text-left shadow-2xl sm:p-7">
        ...
        <label className="block"><span className="mb-2 block text-xs font-black uppercase tracking-wider text-muted-foreground">WhatsApp</span><div className="flex items-center gap-3 rounded-xl border border-border bg-background px-4 py-3"><Phone className="h-4 w-4 text-primary" /><input name="phone" type="tel" placeholder="(00) 00000-0000" className="w-full bg-transparent text-sm text-foreground outline-none placeholder:text-muted-foreground" /></div></label>
